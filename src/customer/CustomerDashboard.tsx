...
import {
    ...
    ExternalLink, Edit3, Sparkles, Mail
} from 'lucide-react';
import API from '../api';
...
const CustomerDashboard = () => {
    ...
    return (
        <div className="h-screen w-full bg-[#FDFCFB] flex font-['Cormorant_Garamond'] overflow-hidden text-left">
            ...
            <aside className="w-80 bg-[#F2EDE4] border-r border-[#E5E1DA] hidden lg:flex flex-col p-12 h-full justify-between">
                <div className="space-y-16">
                    ...
                    <nav className="space-y-10 font-['Montserrat'] font-black uppercase text-[10px] tracking-[0.3em]">
                        <button onClick={() => navigate('/marketplace')} className="flex items-center gap-5 w-full text-[#2C2C2C]/30 hover:text-[#2C2C2C] transition-all">
            ...
            <main className="flex-1 overflow-y-auto bg-[#FDFCFB] p-12 md:p-24 relative">
                ...
                {activeTab === 'My Artisans' && (
                    <header className="mb-24 flex justify-between items-center border-b border-[#E5E1DA] pb-12 relative z-10">
                        ...
                        <div className="space-y-12 animate-in fade-in duration-700">
                            ...
                            <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
                                {hiredHistory.length > 0 ? hiredHistory.map((artisan: any) => (
                                    <div key={artisan._id} className="bg-white border border-[#E5E1DA] p-10 flex flex-col md:flex-row gap-8 items-center group hover:border-[#D4AF37] transition-all duration-500">
                                        <div className="w-24 h-24 bg-[#F2EDE4] rounded-full flex items-center justify-center text-[#2C2C2C] group-hover:bg-[#D4AF37] group-hover:text-white transition-all duration-500">
                                            <Scissors size={28} strokeWidth={1} />
                                        </div>
                                        <div className="flex-1 space-y-4">
                                            <div>
                                                <h3 className="text-4xl font-['Playfair_Display'] italic leading-none">{artisan.tailorName}</h3>
                                            ...
                                            <div className="flex gap-6 font-['Montserrat'] font-black uppercase text-[9px] tracking-widest">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-10">
                                {favorites.length > 0 ? favorites.map((fav: any) => (
                                    <div key={fav._id} className="group relative aspect-[4/5] bg-[#F2EDE4] overflow-hidden border border-[#E5E1DA] cursor-pointer" onClick={() => viewArtisanFromWork(fav)}>
                                        ...
                                        <div className="absolute inset-0 bg-[#2C2C2C]/80 opacity-0 group-hover:opacity-100 transition-all duration-500 p-10 flex flex-col justify-between text-white">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-20 gap-y-12">
                                    {[
                                        ...
                                        <div key={idx} className="border-b border-[#F2EDE4] pb-4 space-y-2">
                                            ...
                                            <p className="text-3xl italic text-[#2C2C2C] leading-none">{item.value}</p>
                                        </div>
                                    ))}
                                </div>
                            </section>

                            {/* SECURITY SECTION: Matching Tailor Dashboard */}
                    ...
                    {activeTab === 'Leave Review' && (
                        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                            <div className="mb-12 space-y-4">
                                <h3 className="text-5xl font-['Playfair_Display'] italic text-[#2C2C2C]">The Community Ledger</h3>
                            ...
                            <div className="bg-white border border-[#E5E1DA] p-10 shadow-sm">
